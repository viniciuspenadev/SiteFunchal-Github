...
$JOBS = [
    [
        'id' => 'encarregado-expedicao',
        'title' => 'Encarregado de Expedição',
        'department' => 'Operacional',
        'location' => 'Tatuapé, São Paulo - SP',
        'type' => 'CLT',
        'workload' => '44h semanais',
        'summary' => 'Atuação em empresa do segmento de pescados congelados, acompanhando a rotina de expedição, estoque, separação de pedidos e movimentação de mercadorias em ambiente refrigerado e câmaras frigoríficas.',
        'description' => 'A função envolve tanto atividades operacionais quanto acompanhamento e controle dos processos da expedição, sendo importante ter atenção, organização e facilidade para trabalhar com pedidos, conferências e sistemas.<br><br><strong>Principais responsabilidades:</strong><br>• Separação e conferência de pedidos<br>• Organização e controle de estoque<br>• Acompanhamento de carga e descarga de mercadorias<br>• Conferência de produtos para entrega<br>• Separação de mercadorias para roteiros do dia seguinte<br>• Recebimento e organização dos pedidos enviados pela equipe de vendas externas<br>• Controle de entrada e saída de produtos<br>• Conferência de notas, pedidos e mercadorias<br>• Apoio na organização da expedição e armazenagem<br><br><strong>Importante:</strong> Não buscamos apenas um perfil braçal para estoque. Procuramos uma pessoa com perfil mais analítico e organizado, que consiga acompanhar os processos da expedição, conferir pedidos, controlar informações e auxiliar na organização operacional do setor.',
        'requirements' => [
            'Ensino Médio completo;',
            'Boa comunicação e organização;',
            'Facilidade para trabalhar com computador e sistemas;',
            'Conhecimento básico em e-mail, digitação e conferência de pedidos;',
            'Boa leitura e atenção para conferência de informações e mercadorias;',
            'Perfil responsável, atento e comprometido.'
        ],
        'benefits' => [
            'Auxílio-combustível;',
            'Vale-refeição.'
        ...
        'differentials' => [
            'Experiência na área de estoque, expedição ou logística;',
            'Experiência com alimentos congelados será um diferencial.'
        ],
