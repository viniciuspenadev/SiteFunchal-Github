...
return [
    ...
    // Products Data
    'prod_salmon_name' => 'Salmão Premium Chileno',
    'prod_salmon_desc' => 'Filé de salmão fresco importado do Chile, rico em ômega 3. Coloração intensa e textura firme.',
    'prod_salmon_origin' => 'Chile (Importado)',
    'prod_salmon_temp' => 'Resfriado (0°C a 4°C)',
    'prod_salmon_pairing' => 'Sashimi, Grelhados, Assados',

    'prod_shrimp_gg_name' => 'Camarão Rosa GG',
    'prod_shrimp_gg_desc' => 'Camarão Rosa selvagem, tamanho GG, limpo e descascado. Sabor adocicado e textura firme.',
    'prod_shrimp_gg_origin' => 'Brasil (Sul)',
    'prod_shrimp_gg_temp' => 'Congelado (-18°C)',
    'prod_shrimp_gg_pairing' => 'Moquecas, Risotos, Grelhados',

    'prod_octopus_name' => 'Polvo Espanhol',
    'prod_octopus_desc' => 'Polvo espanhol legítimo, conhecido por sua maciez e sabor inigualável. Padrão Todo (Inteiro).',
    'prod_octopus_origin' => 'Espanha (Galícia)',
    'prod_octopus_temp' => 'Congelado (-18°C)',
    'prod_octopus_pairing' => 'À Lagareiro, Carpaccio, Grelhado',

    'prod_paella_name' => 'Kit Paella Valenciana',
    'prod_paella_desc' => 'Kit completo com anéis de lula, mexilhões, camarões e cubos de peixe. Praticidade para sua paella.',
    'prod_paella_origin' => 'Mix Nacional/Importado',
    ...
    'prod_lobster_origin' => 'Brasil / Caribe',
    'prod_lobster_temp' => 'Congelado (-18°C)',
    'prod_lobster_pairing' => 'Grelhada na Manteiga, Thermidor',

    'prod_cod_name' => 'Bacalhau Gadus Morhua',
    'prod_cod_desc' => 'O autêntico Bacalhau da Noruega. Lombos altos, claros e que se desfazem em lascas perfeitas.',
    'prod_cod_origin' => 'Noruega',
    'prod_cod_temp' => 'Refrigerado / Seco',
    'prod_cod_pairing' => 'Vinho Verde, Assado, Gomes de Sá',

    'prod_oysters_name' => 'Ostras Frescas',
    'prod_oysters_desc' => 'Ostras cultivadas em águas frias, garantindo sabor delicado e textura única. Entregues vivas.',
    'prod_oysters_origin' => 'Florianópolis - SC',
    'prod_oysters_temp' => 'Vivas / Resfriadas',
    'prod_oysters_pairing' => 'Espumante, Limão, In Natura',

    'prod_squid_rings_name' => 'Lula em Anéis IQF',
    'prod_squid_rings_desc' => 'Anéis de lula padronizados e congelados individualmente (IQF). Praticidade total e zero desperdício.',
    'prod_squid_rings_origin' => 'Argentina / China',
    'prod_squid_rings_temp' => 'Congelado IQF',
    'prod_squid_rings_pairing' => 'À Dorê, Molhos, Paella',

    'prod_tilapia_name' => 'Tilápia Saint Peter',
    'prod_tilapia_desc' => 'Filés de Tilápia premium, sem espinhas e sem sabor de terra. Carne branca, leve e muito saudável.',
    'prod_tilapia_origin' => 'Brasil (Cultivo Sustentável)',
    'prod_tilapia_temp' => 'Resfriado',
    'prod_tilapia_pairing' => 'Grelhado, Ceviche, Empanado',

    'prod_scallops_name' => 'Vieiras Canadenses',
    'prod_scallops_desc' => 'Vieiras selvagens do canadá, tamanho U-10 (gigantes). Sabor adocicado e textura amanteigada incomparável.',
    'prod_scallops_origin' => 'Canadá (Importado)',
    'prod_scallops_temp' => 'Congelado IQF',
    'prod_scallops_pairing' => 'Selada, Risoto, Gratinada',

    'prod_caviar_name' => 'Caviar Beluga',
    'prod_caviar_desc' => 'O "Ouro Negro" da gastronomia. Ovas de esturjão Beluga, textura cremosa e explosão de sabor marinho.',
    'prod_caviar_origin' => 'Irã',
    'prod_caviar_temp' => 'Resfriado (0°C a 2°C)',
    'prod_caviar_pairing' => 'Blinis, Vodka, Champanhe',
